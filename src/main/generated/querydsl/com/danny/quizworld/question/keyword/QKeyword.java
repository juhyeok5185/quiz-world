...
public class QKeyword extends EntityPathBase<Keyword> {
    ...
    private static final long serialVersionUID = 1027229452L;
    ...
    public final com.danny.quizworld.question.QQuestion question;
    ...
    public QKeyword(Class<? extends Keyword> type, PathMetadata metadata, PathInits inits) {
        ...
        this.question = inits.isInitialized("question") ? new com.danny.quizworld.question.QQuestion(forProperty("question"), inits.get("question")) : null;
    }
